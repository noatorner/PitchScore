...
const KNOWN_RESULTS = {
  ...
  // m10: NED 2-2 JPN  (14 jun)
  m10: [
    { min:90,  type:"info", icon:"🏁", label:"Final: Países Bajos 2-2 Japón" },
    { min:7,   type:"act",  icon:"⬆️", action:"Centro al área",  side:"home", team:"NED", zoneId:"wing_der_2",   zone:"Banda derecha · sector 3",            pts:10 },
    { min:13,  type:"act",  icon:"🥅", action:"Tiro a puerta",   side:"home", team:"NED", zoneId:"boxF_der",     zone:"Frontal del área derecha",            pts:25 },
    { min:18,  type:"act",  icon:"⚽", action:"Gol",              side:"home", team:"NED", zoneId:"box6_der",     zone:"Área pequeña derecha",                pts:40 },
    { min:18,  type:"act",  icon:"👟", action:"Asistencia",       side:"home", team:"NED", zoneId:"boxN_der",     zone:"Área grande derecha · flanco sup.",   pts:15 },
    { min:24,  type:"act",  icon:"🟨", action:"Tarjeta amarilla", side:"away", team:"JPN", zoneId:"med_0",        zone:"Mediocampo · sector 1",               pts:5  },
    { min:31,  type:"act",  icon:"🚩", action:"Córner",           side:"home", team:"NED", zoneId:"corner_n_der", zone:"Córner superior derecho",             pts:10 },
    { min:37,  type:"act",  icon:"⚽", action:"Gol",              side:"away", team:"JPN", zoneId:"box6_izq",     zone:"Área pequeña izquierda",              pts:40 },
    { min:37,  type:"act",  icon:"👟", action:"Asistencia",       side:"away", team:"JPN", zoneId:"boxF_izq",     zone:"Frontal del área izquierda",          pts:15 },
    { min:44,  type:"act",  icon:"🟨", action:"Tarjeta amarilla", side:"home", team:"NED", zoneId:"med_2",        zone:"Mediocampo · sector 2",               pts:5  },
    { min:52,  type:"act",  icon:"⬆️", action:"Centro al área",  side:"away", team:"JPN", zoneId:"wing_izq_4",   zone:"Banda izquierda · sector 5",          pts:10 },
    { min:57,  type:"act",  icon:"⚽", action:"Gol",              side:"away", team:"JPN", zoneId:"box6_izq",     zone:"Área pequeña izquierda",              pts:40 },
    { min:63,  type:"act",  icon:"🥅", action:"Tiro a puerta",   side:"home", team:"NED", zoneId:"boxF_der",     zone:"Frontal del área derecha",            pts:25 },
    { min:69,  type:"act",  icon:"🚩", action:"Córner",           side:"away", team:"JPN", zoneId:"corner_s_izq", zone:"Córner inferior izquierdo",           pts:10 },
    { min:74,  type:"act",  icon:"🟨", action:"Tarjeta amarilla", side:"away", team:"JPN", zoneId:"med_3",        zone:"Mediocampo · sector 3",               pts:5  },
    { min:79,  type:"act",  icon:"⚽", action:"Gol",              side:"home", team:"NED", zoneId:"penspot_der",  zone:"Punto de penalti derecho",            pts:40 },
    { min:87,  type:"act",  icon:"🟨", action:"Tarjeta amarilla", side:"home", team:"NED", zoneId:"med_1",        zone:"Mediocampo · sector 1",               pts:5  },
  ],
  // m11: CIV 1-0 ECU  (14 jun)
  m11: [
    { min:90,  type:"info", icon:"🏁", label:"Final: Costa de Marfil 1-0 Ecuador" },
    { min:11,  type:"act",  icon:"🟨", action:"Tarjeta amarilla", side:"away", team:"ECU", zoneId:"med_2",        zone:"Mediocampo · sector 2",               pts:5  },
    { min:19,  type:"act",  icon:"⬆️", action:"Centro al área",  side:"home", team:"CIV", zoneId:"wing_der_3",   zone:"Banda derecha · sector 4",            pts:10 },
    { min:26,  type:"act",  icon:"🥅", action:"Tiro a puerta",   side:"home", team:"CIV", zoneId:"boxF_der",     zone:"Frontal del área derecha",            pts:25 },
    { min:33,  type:"act",  icon:"🚩", action:"Córner",           side:"home", team:"CIV", zoneId:"corner_n_der", zone:"Córner superior derecho",             pts:10 },
    { min:41,  type:"act",  icon:"⚽", action:"Gol",              side:"home", team:"CIV", zoneId:"box6_der",     zone:"Área pequeña derecha",                pts:40 },
    { min:41,  type:"act",  icon:"👟", action:"Asistencia",       side:"home", team:"CIV", zoneId:"boxS_der",     zone:"Área grande derecha · flanco inf.",   pts:15 },
    { min:48,  type:"act",  icon:"🟨", action:"Tarjeta amarilla", side:"away", team:"ECU", zoneId:"med_0",        zone:"Mediocampo · sector 1",               pts:5  },
    { min:55,  type:"act",  icon:"⬆️", action:"Centro al área",  side:"away", team:"ECU", zoneId:"wing_izq_2",   zone:"Banda izquierda · sector 3",          pts:10 },
    { min:61,  type:"act",  icon:"🥅", action:"Tiro a puerta",   side:"away", team:"ECU", zoneId:"boxF_izq",     zone:"Frontal del área izquierda",          pts:25 },
    { min:68,  type:"act",  icon:"🚩", action:"Córner",           side:"away", team:"ECU", zoneId:"corner_s_izq", zone:"Córner inferior izquierdo",           pts:10 },
    { min:76,  type:"act",  icon:"🟥", action:"Tarjeta roja",     side:"away", team:"ECU", zoneId:"med_3",        zone:"Mediocampo · sector 3",               pts:10 },
    { min:83,  type:"act",  icon:"🟨", action:"Tarjeta amarilla", side:"home", team:"CIV", zoneId:"med_1",        zone:"Mediocampo · sector 1",               pts:5  },
  ],
  // m12: BEL 1-1 EGY  (15 jun)
  m12: [
    { min:90,  type:"info", icon:"🏁", label:"Final: Bélgica 1-1 Egipto" },
    { min:8,   type:"act",  icon:"⬆️", action:"Centro al área",  side:"home", team:"BEL", zoneId:"wing_der_1",   zone:"Banda derecha · sector 2",            pts:10 },
    { min:14,  type:"act",  icon:"🥅", action:"Tiro a puerta",   side:"home", team:"BEL", zoneId:"boxF_der",     zone:"Frontal del área derecha",            pts:25 },
    { min:19,  type:"act",  icon:"🚩", action:"Córner",           side:"home", team:"BEL", zoneId:"corner_n_der", zone:"Córner superior derecho",             pts:10 },
    { min:23,  type:"act",  icon:"⚽", action:"Gol",              side:"home", team:"BEL", zoneId:"box6_der",     zone:"Área pequeña derecha",                pts:40 },
    { min:23,  type:"act",  icon:"👟", action:"Asistencia",       side:"home", team:"BEL", zoneId:"boxN_der",     zone:"Área grande derecha · flanco sup.",   pts:15 },
    { min:30,  type:"act",  icon:"🟨", action:"Tarjeta amarilla", side:"away", team:"EGY", zoneId:"med_3",        zone:"Mediocampo · sector 3",               pts:5  },
    { min:38,  type:"act",  icon:"🥅", action:"Tiro a puerta",   side:"away", team:"EGY", zoneId:"boxF_izq",     zone:"Frontal del área izquierda",          pts:25 },
    { min:45,  type:"act",  icon:"🟨", action:"Tarjeta amarilla", side:"home", team:"BEL", zoneId:"med_1",        zone:"Mediocampo · sector 1",               pts:5  },
    { min:51,  type:"act",  icon:"⬆️", action:"Centro al área",  side:"away", team:"EGY", zoneId:"wing_izq_3",   zone:"Banda izquierda · sector 4",          pts:10 },
    { min:58,  type:"act",  icon:"🚩", action:"Córner",           side:"away", team:"EGY", zoneId:"corner_s_izq", zone:"Córner inferior izquierdo",           pts:10 },
    { min:63,  type:"act",  icon:"🎯", action:"Penalti",          side:"away", team:"EGY", zoneId:"penspot_izq",  zone:"Punto de penalti izquierdo",          pts:50 },
    { min:63,  type:"act",  icon:"⚽", action:"Gol (penalti)",   side:"away", team:"EGY", zoneId:"penspot_izq",  zone:"Punto de penalti izquierdo",          pts:40 },
    { min:71,  type:"act",  icon:"🥅", action:"Tiro a puerta",   side:"home", team:"BEL", zoneId:"boxF_der",     zone:"Frontal del área derecha",            pts:25 },
    { min:78,  type:"act",  icon:"🟨", action:"Tarjeta amarilla", side:"away", team:"EGY", zoneId:"med_2",        zone:"Mediocampo · sector 2",               pts:5  },
    { min:85,  type:"act",  icon:"🚩", action:"Córner",           side:"home", team:"BEL", zoneId:"corner_s_der", zone:"Córner inferior derecho",             pts:10 },
  ],
  // m13: ESP 0-0 CPV  (15 jun)
  m13: [
    { min:90,  type:"info", icon:"🏁", label:"Final: España 0-0 Cabo Verde" },
    { min:9,   type:"act",  icon:"⬆️", action:"Centro al área",  side:"home", team:"ESP", zoneId:"wing_der_0",   zone:"Banda derecha · sector 1",            pts:10 },
    { min:15,  type:"act",  icon:"🥅", action:"Tiro a puerta",   side:"home", team:"ESP", zoneId:"boxF_der",     zone:"Frontal del área derecha",            pts:25 },
    { min:21,  type:"act",  icon:"🚩", action:"Córner",           side:"home", team:"ESP", zoneId:"corner_n_der", zone:"Córner superior derecho",             pts:10 },
    { min:27,  type:"act",  icon:"🟨", action:"Tarjeta amarilla", side:"away", team:"CPV", zoneId:"med_3",        zone:"Mediocampo · sector 3",               pts:5  },
    { min:34,  type:"act",  icon:"🥅", action:"Tiro a puerta",   side:"home", team:"ESP", zoneId:"boxF_der",     zone:"Frontal del área derecha",            pts:25 },
    { min:38,  type:"act",  icon:"🚩", action:"Córner",           side:"home", team:"ESP", zoneId:"corner_s_der", zone:"Córner inferior derecho",             pts:10 },
    { min:44,  type:"act",  icon:"🟨", action:"Tarjeta amarilla", side:"home", team:"ESP", zoneId:"med_2",        zone:"Mediocampo · sector 2",               pts:5  },
    { min:49,  type:"act",  icon:"⬆️", action:"Centro al área",  side:"home", team:"ESP", zoneId:"wing_izq_1",   zone:"Banda izquierda · sector 2",          pts:10 },
    { min:55,  type:"act",  icon:"🥅", action:"Tiro a puerta",   side:"home", team:"ESP", zoneId:"boxF_der",     zone:"Frontal del área derecha",            pts:25 },
    { min:61,  type:"act",  icon:"⬆️", action:"Centro al área",  side:"away", team:"CPV", zoneId:"wing_izq_4",   zone:"Banda izquierda · sector 5",          pts:10 },
    { min:67,  type:"act",  icon:"🚩", action:"Córner",           side:"home", team:"ESP", zoneId:"corner_n_der", zone:"Córner superior derecho",             pts:10 },
    { min:73,  type:"act",  icon:"🟨", action:"Tarjeta amarilla", side:"away", team:"CPV", zoneId:"med_0",        zone:"Mediocampo · sector 1",               pts:5  },
    { min:79,  type:"act",  icon:"🥅", action:"Tiro a puerta",   side:"home", team:"ESP", zoneId:"boxF_der",     zone:"Frontal del área derecha",            pts:25 },
    { min:84,  type:"act",  icon:"⬆️", action:"Centro al área",  side:"home", team:"ESP", zoneId:"wing_der_2",   zone:"Banda derecha · sector 3",            pts:10 },
    { min:88,  type:"act",  icon:"🥅", action:"Tiro a puerta",   side:"home", team:"ESP", zoneId:"boxN_der",     zone:"Área grande derecha · flanco sup.",   pts:25 },
  ],
};
